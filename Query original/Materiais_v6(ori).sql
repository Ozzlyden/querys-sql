...
from (select * from TB_SUPRI_MATERIAIS A
inner join (select todos from (select cd_produto todos from TB_SUPRI_MATERIAIS))b on a.cd_produto = b.todos
WHERE 1=1
